...
\r
  ...
  float time = u_time;\r
  \r
  float MAX_DIST = 24.0;\r
  const int MAX_STEPS = 60;\r
\r
...
\r
  ...
  float dist = 0.0;\r
\r
  float step_fac = 0.6/length(dir);\r
\r
...
for(int i = 0; i < MAX_STEPS; i++){\r
    ...
    loc = loc + step_fac*dir*domain2(loc,u_time);\r
  }\r
\r
  float val = exp(-0.05*dist)/1.0;\r
  // float val = 1.0;\r
  \r
