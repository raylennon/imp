...
\r
  ...
  float camera_sign = sign(domain(loc,u_time));\r
  float current_sign = camera_sign;\r
\r
\r
\r
...
\r
  ...
  fragColor.xyz *= 0.2 * normalize(v_normal) / step_fac;\r
  fragColor.xyz += 0.2;\r
\r
  // fragColor.xyz = vec3(length(fragColor.xyz));\r
\r
  // fragColor.yz -= 1.0*abs(length(v_normal)-1.0);\r
\r
}`;export{o as default};
